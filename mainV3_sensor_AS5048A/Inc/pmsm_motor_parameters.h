...
#define RS                      3.26 /* Stator resistance , ohm*/
...
#define MOTOR_VOLTAGE_CONSTANT  5.6 /*!< Volts RMS ph-ph /kRPM */
#define MOTOR_MAX_SPEED_RPM     1446 /*!< Maximum rated speed  */
#define NOMINAL_CURRENT_A       0.81

#define ID_DEMAG_A              -0.81 /*!< Demagnetization current */
