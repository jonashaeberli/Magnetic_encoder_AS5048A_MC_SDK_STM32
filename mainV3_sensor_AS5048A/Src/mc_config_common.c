...
#ifndef AS5048A_SPD_FIFO_DEPTH_MAX
#define AS5048A_SPD_FIFO_DEPTH_MAX  16u
#endif

extern SPI_HandleTypeDef hspi3;

AS5048A_SPD_Handle_t AS5048A_SPD_M1 =
{
  ._Super =
  {
  ...
  .pSpi                = &hspi3,
  .CsPort              = AS5048A_NSS_GPIO_Port,
  .CsPin               = AS5048A_NSS_Pin,

  .SpeedSamplingFreqHz = MEDIUM_FREQUENCY_TASK_RATE,
  .SpeedBufferSize     = AS5048A_SPD_FIFO_DEPTH_MAX,
...
/**
  * @brief  Alignment Controller parameters Motor 1 – for TAD2144.
  */
AS5048A_AlignCtrl_Handle_t AS5048A_AlignCtrlM1 =
{
